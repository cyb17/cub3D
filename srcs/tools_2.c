...
/*   Updated: 2024/02/22 17:13:28 by jp-de-to         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_wall_pixel_colon(t_gameconfig *c, t_draw *d, t_img *txt)
{
	char	*ptr;
	...
	{
		find_pixel_color_in_txt(c, d, txt);
		d->color = convert_chars_to_int()
		d->draw_start++;
	}
}